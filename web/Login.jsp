...
<html>
    <head>
        ...
        <link href="assets/css/price-range.css" rel="stylesheet" type="text/css"/>
        <link href="assets/css/responsive.css" rel="stylesheet" type="text/css"/>
        <a href="assets/fonts/FontAwesome.otf"></a>
        <a href="assets/fonts/fontawesome-webfont.svg"></a>
        <a href="assets/fonts/glyphicons-halflings-regular.svg"></a>
        <a href="assets/fonts/glyphicons-halflings-regular.woff"></a>
                    ...
                    <div class="row">
                        <div class="col-md-4 clearfix">
                            <div class="logo pull-left">
                                <img src="assets/img/imags/foto1.png" alt=""/></a>
                            </div>
                    ...
                    <div class="col-sm-4 col-sm-offset-1">
                        <div class="login-form"><!--login form-->
                            ...
                            <form action="login.do" method="POST">
                                <input id="em" type="email" name="email" placeholder="Email Address" />
                                <input id="pa" type="password" name="pass" placeholder="Contraseña" />
